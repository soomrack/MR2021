...
void Foolproof(int Position, char Mark, int *player){ //Foolproof for mistakes
    ...
    if (Position == 2 && square[1] == '2')
        square[1] = Mark;
    else
    if (Position == 3 && square[2] == '3')
        square[2] = Mark;
    else
    if (Position == 4 && square[3] == '4')
        square[3] = Mark;
    else
    if (Position == 5 && square[4] == '5')
        square[4] = Mark;
    else
    if (Position == 6 && square[5] == '6')
        square[5] = Mark;
    else
    if (Position == 7 && square[6] == '7')
        square[6] = Mark;
    else
    if (Position == 8 && square[7] == '8')
        square[7] = Mark;
    else
    if (Position == 9 && square[8] == '9')
        square[8] = Mark;
    else
    {
        ...
        system("pause"); //Wait for press key
    }
}

int User() //User interface
{
    ...
    do{
        ...
        Foolproof(Position, Mark, &player);//Foolproof
        player++;       //Next turn
