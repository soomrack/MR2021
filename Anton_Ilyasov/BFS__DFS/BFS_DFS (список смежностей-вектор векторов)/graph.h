...
private:
    ...
    std::vector<std::vector<int>> adjacency_list; //—писок смежности
    std::vector<std::vector<int>> adjacency_matrix;//ћатрица смежности
    std::vector<int> restored_path; //путь между двум€ вершинами
